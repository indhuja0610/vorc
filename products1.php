...
<link rel="stylesheet" href='https://cdn.bajajauto.com/css/gogo-three-wheeler/parallax.css'>
    ...
    <style>
        ...
        #parallax1 {
    background-image: url(vimage/vorc 02 (2).png) !important;
}
...
<div class="color-switch">
  <div class="color-pill">
    <span class="dot greenyellow" onclick="changeAuto('greenyellow')"></span>
    <span class="dot yellow" onclick="changeAuto('yellow')"></span>
    <span class="dot green" onclick="changeAuto('green')"></span>
  </div>
</div>
...
<script>
  function changeAuto(color) {
   ...
   setTimeout(() => {
  if (color === "green") {
    auto.src = "vimage/GREEN.png";
  } else if (color === "yellow") {
    auto.src = "vimage/YELLOWWW.png";
  } else if (color === "greenyellow") {
    auto.src = "vimage/YELLOW GREENNN.png";
  }
...
<div class="vehicle-section">
    ...
    <div class="vehicle-left wow fadeInLeft">
        <div class="zoom-box">
            <img src="vimage/imsas.png" class="zoom-trigger" alt="Vehicle Image">
        </div>
    </div>
    ...
    <div class="vehicle-right wow fadeInRight">
        <h2 class="vehicle-heading">
            ...
            Powering the Future with<br> <span class="highlight">METRO XL</span>
        </h2>

     

        <p class="vehicle-text">
            With METRO XL, every ride is designed to stay steady, strong, and dependable for every
            duty of the day. Engineered for reliability and enhanced performance,
            it's built to deliver consistent efficiency every single time.
        </p>
    </div>
</div>
...
.vehicle-left img {
  ...
  width: 473px;
    ...
    /* Stack table and image vertically */
    .content-grid {
        display: flex;
        flex-direction: column;
        gap: 20px;
    ...
    /* Table container full width and horizontal scroll if needed */
    .table-container {
        overflow-x: auto;
        width: 100%;
    }
    ...
    .spec-table td.value {
        text-align: left; /* Avoid text going out of screen */
    }
...
<!-- <h2 id="he1">FEATURES</h2>
<div class="fet">
<img src="vimage/1 (1).png">
</div> -->
 ...
 <div class="overlay-gradient">
            <div class="swiper-wrapper pb-30px marquee-slide" id="swiper-wrapper" aria-live="off">
                <marquee behavior="scroll" scrollamount="20" direction="right" class="marquee-transition">Product Overview</marquee>
            </div>
        </div>
        <div class="container-fluid section">
            <div class="row-section">
                <div class="col-md-6 parallax" id="parallax1" style="background-image: url('vimage/nfbvkgfb.png') !important;"></div>
...
<div class="row">
  <div class="col-md-12" id="para">
    <p class="heading" style="color:  #009cff;">Electric Power Meets Everyday Reliability</p>
    <p class="parallax-para">
      <p class="prd-overview-desc">
The METRO XL is where electric power meets everyday reliability. This vehicle is engineered to deliver long life and dependable performance, ensuring it keeps you on the road without frequent interruptions—a perfect fit for modern urban mobility and daily commutes.    </p>
  </div>
</div>
        ...
        <div class="container-fluid section">
            <div class="row-section">
                <div class="col-md-6 parallax" id="parallax2" style="background-image: url('vimage/fgdhtfgjh.png') !important;"></div>
                <div class="col-md-6 content-container">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex align-items-center ">
                                ...
                                <div class="heading-text d-flex align-items-center">
                                            ...
                                            <div class="row">
  <div class="col-md-12" id="para">
    <p class="heading" style="color: #009cff;">Performance & Range You Can Trust</p>
    <p class="parallax-para">
      <p class="prd-overview-desc">
       
The <span style=".lg {
    font-family: 'Magneto', sans-serif;
}">VORC</span> METRO XL encourages a commitment to electric mobility, urging users to "Ride Smart, Go Electric!". It embodies the concept of "Power & Precision, Redefined Through  Innovation" , offering a vehicle that is built to last.  </div>
</div>
                    </div>
            </div>
        </div>
        <div class="container-fluid section">
            <div class="row-section">
                <div class="col-md-6 parallax" id="parallax3" style="background-image: url('vimage/guegugfhrg.png') !important;"></div>
                <div class="col-md-6 content-container">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex align-items-center ">
                                ...
                                <div class="heading-text d-flex align-items-center">
                                           ...
                                           <div class="row">
  <div class="col-md-12" id="para">
    <p class="heading" style="color: #009cff;">Comfort, Convenience & Versatility</p>
    <p class="parallax-para">
      <p class="prd-overview-desc">
      Designed with the driver and passenger in mind, the METRO XL offers the largest cabin space in its class. With advanced dual suspension and ergonomic seating, every journey is as smooth as it is productive.   </p>
    </p>
  </div>
</div>
                    </div>
...
<div class="feature-container">
    <div class="mosaic-grid">
        ...
        <div class="mosaic-card">
            <img src="vimage/jj7.png" alt="Metro XL On Road" class="zoom-trigger">
            </div>

        <div class="mosaic-card">
            <img src="vimage/jj9.png" alt="Spacious Seat" class="zoom-trigger">
        ...
        <div class="mosaic-card">
            <img src="vimage/jj8.png" alt="Heavy Duty Tyres" class="zoom-trigger">
            <div class="card-content">
        ...
        <div class="mosaic-card">
            <img src="vimage/jj10.png" alt="Front Dual Suspension" class="zoom-trigger">
            <div class="card-content">
        ...
        <div class="mosaic-card">
            <img src="vimage/jj11.png" alt="Metro XL On Road" class="zoom-trigger">
            </div>

        <div class="mosaic-card">
            <img src="vimage/jj6.png" alt="Spacious Seat" class="zoom-trigger">
            <div class="card-content">
                <!-- <h3 class="card-title">Biggest Passenger Cabin</h3>
                <p class="card-desc">
                    A spacious cabin offers enhanced comfort for a more relaxed journey and higher profitability.
...
<div class="spec-container">
    ...
    <div class="header-section">
        <h2>METRO XL</h2>
        <p>Explore how Metro XL delivers Power & Precision for Passenger transport</p>
    </div>
    ...
    <div class="tabs">
        ...
        <button class="tab-btn" onclick="openTab(event, 'Comfort')">Comfort</button>
        ...
        <div class="table-container">
            <table class="spec-table">
                <tr>
                    ...
                    <td class="value">53 km/hr</td>
                </tr>
                <tr>
                    <td class="label">Drive Modes</td>
                    <td class="value">Eco, Boost, Reverse</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="label">Acceleration (0-30 kmph)</td>
                    <td class="value">8 Secs (Boost Mode)</td>
                </tr>
                <tr>
                    <td class="label">Certified Range (ARAI)</td>
                    <td class="value">268 km</td>
                </tr>
                <tr>
                    <td class="label">True Range</td>
                    <td class="value">170 ± 10 km</td>
                </tr>
            </table>
        </div>
       <div class="product-image">
    <span class="product-name">Metro XL</span>
   
    <img src="vimage/Untitled design 1.png" alt="Metro XL Passenger Vehicle" class="zoom-trigger">
</div>
        ...
        <div class="table-container">
            <table class="spec-table">
                <tr>
                    ...
                    <td class="value">Lithium Ferro Phosphate (LFP)</td>
                </tr>
                <tr>
                    <td class="label">Capacity</td>
                    <td class="value">11.8 kWh (230 Ah)</td>
                </tr>
                <tr>
                    <td class="label">Voltage</td>
                    <td class="value">51.2 V</td>
                </tr>
                <tr>
                    <td class="label">Battery Life</td>
                    <td class="value">> 2500 Cycles</td>
                </tr>
                <tr>
                    <td class="label">Charging Time</td>
                    <td class="value">4 hrs (Standard Conditions)</td>
                </tr>
                <tr>
                    <td class="label">BMS</td>
                    <td class="value">Advanced Intelligent BMS</td>
                </tr>
            </table>
        </div>
        <div class="product-image">
            <span class="product-name">Metro XL</span>
            <img src="vimage/vrdf.png" alt="Metro XL Battery" class="zoom-trigger">
        </div>
    </div>
    ...
    <div id="Safety" class="tab-content content-grid">
        <div class="table-container">
            <table class="spec-table">
                <tr>
                    <td class="label">IP Rating (Water/Dust)</td>
                    <td class="value">IP67</td>
                </tr>
                <tr>
                    <td class="label">Chassis Build</td>
                    <td class="value">Rock-Solid Monocoque Chassis</td>
                </tr>
                <tr>
                    <td class="label">Braking System</td>
                    <td class="value">Hydraulic Expanding Friction Shoe</td>
                </tr>
                <!-- <tr>
                    <td class="label">Security</td>
                    <td class="value">Remote Immobilization & Alerts</td>
                </tr> -->
                <tr>
                    <td class="label">Regenerative Braking</td>
                    <td class="value">Yes (15-18%)</td>
                </tr>
                <tr>
                    <td class="label">Telematics</td>
                    <td class="value">Real-Time Monitoring Enabled</td>
                </tr>
            </table>
        </div>
        <div class="product-image">
            <span class="product-name">Metro XL</span>
            <img src="vimage/safe.png" alt="Metro XL Safety Features" class="zoom-trigger">
        </div>
    </div>

    <div id="Comfort" class="tab-content content-grid">
        <div class="table-container">
            <table class="spec-table">
                <tr>
                    <td class="label">Front Suspension</td>
                    <td class="value">Dual Suspension (Fork with Anti-dive)</td>
                </tr>
                <tr>
                    <td class="label">Rear Suspension</td>
                    <td class="value">Dampened Rubber + Hydraulic Shock</td>
                </tr>
                <tr>
                    <td class="label">Cabin Space</td>
                    <td class="value">Biggest Passenger Cabin</td>
                </tr>
                <tr>
                    <td class="label">Steering</td>
                    <td class="value">Handle Bar Type</td>
                </tr>
            </table>
        </div>
        <div class="product-image">
            <span class="product-name">Metro XL</span>
            <img src="vimage/4.jpg" alt="Metro XL Comfort" class="zoom-trigger">
        </div>
    </div>
        ...
        <div class="table-container">
            <table class="spec-table">
                <tr>
                    ...
                    <td class="value">3153 mm</td>
                </tr>
                <tr>
                    <td class="label">Overall Width</td>
                    <td class="value">1462 mm</td>
                </tr>
                <tr>
                    <td class="label">Overall Height</td>
                    <td class="value">1980 mm</td>
                </tr>
                <tr>
                    <td class="label">Wheel Base</td>
                    <td class="value">2120 mm (Longest)</td>
                </tr>
                <tr>
                    <td class="label">Ground Clearance</td>
                    <td class="value">240 mm (Unladen)</td>
                </tr>
            </table>
        </div>
        <div class="product-image">
            <span class="product-name">Metro XL</span>
            <img src="vimage/raj.png" alt="Metro XL Dimensions" class="zoom-trigger">
        </div>
    </div>
        ...
        <div class="table-container">
            <table class="spec-table">
                <tr>
                    ...
                    <td class="value">IPM (IPV4 Best in Class)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value">59 Nm</td>
                </tr>
                <tr>
                    <td class="label">Wheel Torque</td>
                    <td class="value">812 Nm</td>
                </tr>
                <tr>
                    <td class="label">Gearbox Ratio</td>
                    <td class="value">14.03:1</td>
                </tr>
                <tr>
                    <td class="label">Shaft Technology</td>
                    <td class="value">Revolutionary CV Shaft</td>
                </tr>
            </table>
        </div>
        <div class="product-image">
            <span class="product-name">Metro XL</span>
            <img src="vimage/WhatsApp Image 2026-01-07 at 1.48.44 PM.jpeg" alt="Metro XL Drive Train" class="zoom-trigger">
        </div>
    </div>
...
<h2 id="he">Take the Next Step with Metro XL</h2>
<h4 style="
    text-align: center;
    margin-top: -56px;"
><b>Upgrade your business with the segment's most comfortable electric ride.</b></h4>
<style>
...
<div class="product-page-container">
    ...
    <div class="product-360-view" >
       <img id="productFrame" src="vimage/2222.png" >
    ...
    <div class="details-panel">
        <div class="brand-model">VORC MOTORS</div>
        <h1>METRO XL</h1>
        <div id="int" style="text-align:justify">
             </div>
        ...
        <div class="btn-group">
             <h5 style="text-align:center"> Get the full technical datasheet for the Metro XL</h5>
                 <a href="DOC-20250729-WA0003.pdf"
   target="_blank" 
  ><button class="btn btn-primary" style="    width: 236px !important;
        margin-left: 84px;">Download Brochure</button></a>
            <h5 style="text-align:center"> Experience the stability of the 2120mm wheelbase</h5>
            <button class="btn btn-primary  btn-enquire" style="    width: 236px !important;
       margin-left: 84px;">Enquire Now</button>
...
<section class="riki-gallery-section">
  <div class="gallery-img">
    <img src="vimage/pgallery.png" alt="Gallery Image">
  </div>
</section>
...
.riki-gallery-section {
  padding: 20px;
  margin: 0 auto;
  max-width: 1200px; /* keeps images centered */
}
...
/* Optional: different sizes for big or tall images */
.tall-img {
...
<div class="faq-container faq-component-styles">
    ...
    <div class="faq-heading-group">
        ...
        <p class="faq-subheading">Have questions about our VORC METRO XL</p>
    </div>
    ...
    <div class="faq-qna-wrapper">
        <div class="faq-list">
            ...
            <details class="faq-item">
                <summary class="faq-question">What battery technology powers the Metro XL?</summary>
                <div class="faq-answer">
The Metro XL features a Next-Gen Lithium Ferro Phosphate (LFP) battery. With a
capacity of 11.8 kWh (51.2V, 230 Ah), LFP technology is superior to standard lithium-ion,
offering higher thermal stability, enhanced safety, and a lifespan of over 2,500 charging
cycles.                </div>
            </details>

            <details class="faq-item">
                <summary class="faq-question">How long does it take to charge?</summary>
                <div class="faq-answer">
Efficiency is at the core of the Metro XL. It takes approximately 4 hours to reach a full
charge under standard conditions, ensuring your vehicle spends more time on the road and
less time at the plug.                </div>
            </details>

            <details class="faq-item">
                <summary class="faq-question">What is the certified range of the Metro XL?</summary>
                <div class="faq-answer">
The Metro XL is ARAI certified with a range of 268 km per charge. In typical city driving
conditions, you can reliably expect a range of approximately 170–180 km, making it ideal for
full-day operations.                </div>
            </details>

            <details class="faq-item">
                <summary class="faq-question">What makes the Metro XL chassis different from other electric autos?</summary>
                <div class="faq-answer">
We use a Rock-Solid Monocoque Chassis. Unlike the tubular frames found in cheaper
e-rickshaws, our unibody design provides superior structural strength, better passenger
protection, and much higher durability for heavy-duty daily use.                </div>
            </details>

            <details class="faq-item">
                <summary class="faq-question">What is the top speed and climbing ability?</summary>
                <div class="faq-answer">
The Metro XL is powered by a high-torque motor with a 10 kW peak power, allowing for
a top speed of 59 km/h. It also features a 24% gradeability, ensuring it can climb flyovers
and steep urban inclines even under full load.                </div>
            </details>

            <details class="faq-item">
                <summary class="faq-question">How much can I save on fuel with the Metro XL?</summary>
                <div class="faq-answer">
The Metro XL is highly cost-effective, running at approximately ₹0.60 per km. Compared
to diesel or CNG variants, this allows drivers and fleet owners to save up to ₹1.5 Lakhs per
year in operational costs alone.                </div>
            </details>


            
            <details class="faq-item">
                <summary class="faq-question">What maintenance support do you provide?</summary>
                <div class="faq-answer">
We offer a 3-Year Free Maintenance Program* to ensure a hassle-free ownership
experience. Because the Metro XL has fewer moving parts than an internal combustion
engine, your service downtime and costs are reduced by over 70%.          </div>
            </details>
