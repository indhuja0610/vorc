...
<section class="re-legal-page">
  <div class="re-container">
    ...
    <h1 class="re-title">TERMS AND CONDITIONS</h1>

    <p>
      Welcome to the official website of <strong>VORC Motors Pvt Ltd</strong>
      (“VORC Motors”, “Company”, “we”, or “us”). By accessing this website or
      inquiring about our products (Metro XL, Loader 600 series), you agree to
    ...
    <p>
      ...
      and possess the legal authority to enter into this agreement. If you do
    ...
    <p>
      All content on this website—including but not limited to the VORC Motors
      logo, vehicle designs (Metro XL, Loader 600 PV/DV), technical specifications,
      high-resolution images, and the “VORC Engineering DNA” text—is the exclusive
      property of VORC Motors Pvt Ltd.
    </p>
    <ul>
      <li>You may not reproduce, copy, or distribute any material for commercial purposes without express written consent.</li>
      <li>Any unauthorized use of our trademarks, designs, or engineering blueprints will invite legal action.</li>
    </ul>

    <h2>3. PRODUCT INFORMATION &amp; PRICING</h2>
    <ul>
      <li>
        <strong>Technical Specifications:</strong> Specifications such as range,
        payload, or gradeability are based on controlled internal testing.
        Actual performance may vary depending on driving conditions, terrain,
        and load.
      </li>
      <li>
        <strong>Pricing:</strong> Prices displayed on the website are
        ex-showroom and subject to change without notice. Final on-road pricing,
        including applicable taxes, subsidies, registration, and insurance, will
        be confirmed only by authorized VORC dealers.
      </li>
    </ul>

    <h2>4. TEST DRIVES &amp; ENQUIRIES</h2>
    <ul>
      <li>Submitting a test drive request does not guarantee immediate availability.</li>
      <li>Availability is subject to production schedules and dealer inventory.</li>
      <li>VORC Motors reserves the right to decline test drive requests at its discretion.</li>
    </ul>

    <h2>5. LIMITATION OF LIABILITY</h2>
    <p>
      To the maximum extent permitted under applicable law, VORC Motors Pvt Ltd
      shall not be liable for any indirect, incidental, or consequential damages
      arising from:
    </p>
    <ul>
      <li>The use or inability to use the website</li>
      <li>Inaccuracies or typographical errors in product descriptions</li>
      <li>Delays in manufacturing, logistics, or vehicle delivery</li>
    </ul>

    <h2>6. EXTERNAL LINKS</h2>
    <p>
      This website may include links to third-party websites or platforms.
      VORC Motors does not control and is not responsible for the content,
      security, or privacy practices of such external sites.
    </p>
    ...
    <p>
      VORC Motors reserves the right to modify or update these Terms &amp;
      Conditions at any time without prior notice. Continued use of the website
