...
<body>
    ...
    <!-- Section 3 -->
<section class="re-legal-page">
  <div class="re-container">

    <h1 class="re-title">OFFICIAL LEGAL DISCLAIMER</h1>

    <h2>1. PERFORMANCE &amp; RANGE DISCLAIMER</h2>
    <p>
      The technical specifications, including but not limited to Certified Range
      (ARAI), True Range, Top Speed, and Gradeability, are based on tests conducted
      under controlled laboratory or factory conditions. Actual on-road performance
      is variable and depends on multiple real-world factors, including but not
      limited to:
    </p>
    <ul>
      <li>Total payload (passenger or cargo weight)</li>
      <li>Driving behaviour, speed, and selected drive modes (Eco vs. Boost)</li>
      <li>Road conditions, terrain, and wind resistance</li>
      <li>Battery health, age, and ambient temperature</li>
    </ul>
    <p>
      VORC Motors Pvt Ltd does not guarantee identical performance outcomes for
      every user under all driving conditions.
    </p>

    <h2>2. VISUAL &amp; AESTHETIC REPRESENTATION</h2>
    <p>
      All images, videos, and 3D renders of the Metro XL, Loader 600 PV, and Loader
      600 DV displayed on this website are for illustrative purposes only.
    </p>
    <p>
      The final production vehicle delivered may vary slightly in colour, finish,
      or minor design elements. Accessories, optional equipment, customized paint
      jobs, or special fitments shown in marketing or promotional content may not
      form part of the standard vehicle package and may be offered at additional
      cost.
    </p>

    <h2>3. PRICING &amp; SUBSIDY DISCLAIMER</h2>
    <p>
      All prices mentioned on this website are ex-showroom estimates and are subject
      to change without prior notice.
    </p>
    <p>
      The final on-road price—which includes GST, RTO registration, insurance,
      handling charges, and any other applicable fees—will be confirmed by your
      authorized VORC dealer at the time of purchase.
    </p>
    <p>
      Government incentives or subsidies (including PM E-DRIVE or
      state-specific EV incentives) are governed by prevailing government policies
      at the time of registration. VORC Motors Pvt Ltd shall not be responsible for
      modifications, withdrawal, or delays in subsidy benefits.
    </p>

    <h2>4. ERRORS &amp; OMISSIONS</h2>
    <p>
      While every effort is made to ensure that all information on this website is
      accurate and current, VORC Motors Pvt Ltd does not warrant that all product
      descriptions, pricing details, technical specifications, or other content
      are free from errors or omissions.
    </p>
    <p>
      VORC Motors reserves the right to correct errors, update specifications,
      or modify product information at any time without prior announcement.
    </p>
