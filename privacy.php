...
<body>
  ...
  <div class="re-container">
    ...
    <h1 class="re-title">PRIVACY POLICY</h1>

    <h2>1. INTRODUCTION</h2>
    <p>
      VORC Motors Pvt Ltd (“VORC Motors”, “we”, “us”, or “our”) is committed to
      protecting your personal information. This Privacy Policy explains how
      personal data is collected, used, stored, and disclosed when you access
      our website, manufacturing facilities, or authorised dealer network.
    </p>

    <p>
      This policy applies to information collected through our website and
      during business interactions. By using our services, you consent to the
      practices described in this policy.
    </p>

    <h2>PLEASE NOTE:</h2>
    <p>
      This privacy policy applies only to VORC Motors platforms. If you access
      external links, their privacy policies may differ.
    </p>

    <h2>2. COLLECTION AND USE OF INFORMATION</h2>

    <h3>2.1 COLLECTION OF YOUR INFORMATION</h3>
    <p>
    ...
    <ul>
      ...
      <li>Vehicle and service-related data</li>
      <li>IP address and browser details</li>
    </ul>

    <h2>3. HOW WE USE YOUR DATA</h2>
    <p>
      Personal data is used strictly for lawful purposes such as:
    </p>
    <ul>
      <li>Responding to enquiries and test-drive requests</li>
      <li>Processing warranty and service records</li>
      <li>Complying with statutory and regulatory obligations</li>
    </ul>

    <h2>4. DATA SECURITY</h2>
    <p>
      Reasonable administrative, technical, and physical safeguards are
      implemented to protect your data from unauthorised access.
    </p>

    <h2>5. GRIEVANCE REDRESSAL</h2>
    <p>If you have any concerns, contact:</p>

    <address class="re-address">
      <strong>HR &amp; Compliance Department</strong><br>
      VORC MOTORS PVT LTD<br>
      #133, Karanai Village, Perambakkam Post,<br>
      Thiruvallur, Tamil Nadu – 631402<br><br>
      Email: <a href="mailto:hr@vorcmotors.com">hr@vorcmotors.com</a><br>
      Phone: <a href="tel:+917845365222">+91 78453 65222</a>
    </address>
