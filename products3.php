...
<script>
  function changeProduct(color) {
    ...
    const productImages = {
      ivory: "vimage/rj1.png",
      skyblue: "vimage/rj2.png",
      red: "vimage/rj3.png"
    };
...
<div class="vehicle-section">
    ...
    <div class="vehicle-left wow fadeInLeft">
        <div class="zoom-box">
            <img src="vimage/ld4.png" class="zoom-trigger" alt="Vehicle Image">
        </div>
    </div>
    ...
    <div class="vehicle-right wow fadeInRight">
        <h2 class="vehicle-heading">
            ...
            Powering the Future with<br> <span class="highlight">Loader DV</span>
        </h2>

     

        <p class="vehicle-text">
          Every delivery is optimized for security and volume. Designed for high-frequency urban logistics, it offers a weather-proof, lockable cargo solution that ensures your goods stay safe, steady, and dry. Engineered for maximum uptime, it is the ultimate partner for last-mile delivery success.</p>
    </div>
</div>
...
.number-container {
 ...
 <div class="overlay-gradient">
            <div class="swiper-wrapper pb-30px marquee-slide" id="swiper-wrapper" aria-live="off">
                <marquee behavior="scroll" scrollamount="20" direction="right" class="marquee-transition">Product Overview (Pivoted for Delivery)</marquee>
            </div>
        </div>
        <div class="container-fluid section">
            <div class="row-section">
                <div class="col-md-6 parallax" id="parallax1" style="background-image: url('vimage/ko.png') !important;"></div>
...
10kW Peak Power | High-Grade CV Shaft The most advanced maintenance-free transmission in the segment. Our heavy-duty CV drive shaft eliminates common chain and belt failures, ensuring your delivery fleet stays on the road, not in the workshop.   </p>
  </div>
</div>
        ...
        <div class="container-fluid section">
            <div class="row-section">
                <div class="col-md-6 parallax" id="parallax2" style="background-image: url('vimage/fe7.png') !important;"></div>
                <div class="col-md-6 content-container">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex align-items-center ">
                                ...
                                <div class="heading-text d-flex align-items-center">
                                            ...
                                            <div class="row">
  <div class="col-md-12" id="para">
    <p class="heading" style="color: #009cff;"> Secure Logistics Architecture</p>
    <p class="parallax-para">
      <p class="prd-overview-desc">
       
Weather-Proof Monocoque Chassis A unibody safety cage with a fully enclosed, lockable 170 Cu.ft container. Built to protect valuable cargo from theft and weather, this rugged architecture is engineered for the demands of high-volume urban logistics.
  </div>
</div>
                    </div>
            </div>
        ...
        <div class="container-fluid section">
            <div class="row-section">
                <div class="col-md-6 parallax" id="parallax3" style="background-image: url('vimage/revathy1.png') !important;margin-top:-130px;"></div>
                <div class="col-md-6 content-container">
  ...
  <div class="col-md-12" id="para">
    ...
    <p class="parallax-para">
      <p class="prd-overview-desc">
Under ₹0.60/km Slash your delivery overheads with the lowest running costs in India. Combined with a 3-Year Free Maintenance Program, the Loader 600 DV offers the highest ROI for e-commerce and FMCG fleets.    </p>
  </div>
</div>
                    </div>
            </div>
...
<div class="feature-container">
    <div class="mosaic-grid">
        ...
        <div class="mosaic-card">
            <img src="vimage/jj12.png" alt="Metro XL On Road" class="zoom-trigger">
            </div>

        <div class="mosaic-card">
            <img src="vimage/jj13.png" alt="Spacious Seat" class="zoom-trigger">
        ...
        <div class="mosaic-card">
            <img src="vimage/jj15.png" alt="Heavy Duty Tyres" class="zoom-trigger">
            <div class="card-content">
        ...
        <div class="mosaic-card">
            <img src="vimage/jj14.png" alt="Front Dual Suspension" class="zoom-trigger">
            <div class="card-content">
          ...
          <div class="mosaic-card">
            <img src="vimage/jj16.png" alt="Front Dual Suspension" class="zoom-trigger">
            <div class="card-content">
                <!-- <h3 class="card-title">Front Dual Suspension</h3>
                <p class="card-desc">
                    Advanced fork with anti-dive link ensures smooth rides every time.
...
<div class="spec-container">
    ...
    <div class="header-section">
        <h2>LOADER 600 DV</h2>
        <p>Explore how delivers Power & Precision for Passenger transport</p>
    </div>
    ...
    <div id="Performance" class="tab-content active content-grid">
        <div class="table-container">
            ...
            <tr>
                ...
                <td class="value">~ 170 Cu.ft</td>
            </tr>
        </table>
        </div>
       <div class="product-image">
    <span class="product-name">Loader DV</span>
   
    <img src="vimage/des1.png" alt="Metro XL Passenger Vehicle" class="zoom-trigger">
</div>
    ...
    <div id="Battery" class="tab-content content-grid">
        ...
        <div class="product-image">
            ...
            <img src="vimage/vorc battery.png" alt="Metro XL Battery" class="zoom-trigger">
        </div>
    </div>
    ...
    <div id="Safety" class="tab-content content-grid">
        ...
        <div class="product-image">
            <span class="product-name">Metro XL</span>
            <img src="vimage/sf.png" alt="Metro XL Safety Features" class="zoom-trigger">
        </div>
    </div>
<!-- 
    ...
    <tr>
        ...
        <td class="value">Heavy-Duty Telescopic Hydraulic Fork</td>
    </tr>
    <tr>
        <td class="label">Rear Suspension</td>
        <td class="value">Rubber Spring with Hydraulic Shock Absorber</td>
    </tr>
    <tr>
        <td class="label">Driver Cabin</td>
        <td class="value">Ergonomic Single-Driver Cabin with Utility Layout</td>
    </tr>
    <tr>
        <td class="label">Steering System</td>
        <td class="value">Handlebar Steering for Tight Maneuverability</td>
    </tr>
</table>
        ...
        <div class="product-image">
            <span class="product-name">Metro XL</span>
            <img src="vimage/Untitled design (47).jpg" alt="Metro XL Comfort" class="zoom-trigger">
        </div>
    </div> -->
    ...
    <div id="Dimensions" class="tab-content content-grid">
        <div class="table-container">
         <table class="spec-table">
            <tr>
                ...
                <td class="value">3620 x 1540 x 2285 </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label">Kerb Weight</td>
                <td class="value">662 KG</td>
            </tr>
             <tr>
                <td class="label">Box Size L x W x H (Inside Dimensions )-mm</td>
                <td class="value">1982 x 1527 x 1524</td>
            </tr>
            <!-- <tr>
                <td class="label">Tyre</td>
        ...
        <div class="product-image">
            <span class="product-name">LOADER DV</span>
            <img src="vimage/Build a proportional.png" alt="Metro XL Dimensions" class="zoom-trigger">
        </div>
    </div>
...
<h2 id="he">Take the Next Step with VORC Motors</h2>
<h4 style="text-align:center;margin-top:-47px;"><b>Join the elite circle of entrepreneurs redefining last-mile logistics with India's most advanced electric cargo solutions.</b></h4>
<style>
...
<div class="product-page-container">
    ...
    <div class="product-360-view" >
       <img id="productFrame" src="vimage/dv1-360.png" >
    ...
    <div class="details-panel">
        ...
        <div class="btn-group">
            <h5 style="text-align:center">Get the full Technical Datasheet for the Loader 600 DV</h5>
            <a href="VORC_Loader 600 Brochure.pdf"
   target="_blank" 
  ><button class="btn btn-primary" style="    width: 236px !important;
    margin-left: 86px;">Download Brochure</button></a>
    <h5 style="text-align:center">Built for those who value precision , power and maximum profitability at just ₹0.60/km</h5>
            <button class="btn btn-primary  btn-enquire" style="    width: 236px !important;
    margin-left: 86px;">Enquire Now</button>
        </div>
        <div class=""></div>
    </div>
...
<section class="riki-gallery-section">
  <div class="gallery-img">
    <img src="vimage/des3.png" alt="Gallery image">
  </div>
</section>
    ...
    <div class="faq-list">
        ...
        <details class="faq-item">
            <summary class="faq-question">
                What is the storage capacity of the Loader 600 DV?
            </summary>
            <div class="faq-answer">
             It features a massive 170 Cu.ft fully enclosed container, designed to carry high-volume
parcels and sensitive cargo safely.
            </div>
        </details>

        <details class="faq-item">
            <summary class="faq-question">
                Is the cargo box secure?
            </summary>
            <div class="faq-answer">
               Yes. The delivery vehicle features a lockable, weather-proof hard panel container integrated
into the high-strength monocoque chassis, protecting goods from theft and environmental
damage.
            </div>
        </details>
        ...
        <details class="faq-item">
            <summary class="faq-question">
               What is the real-world range for the Delivery Vehicle?
            </summary>
            <div class="faq-answer">
                The Loader 600 DV offers a True Range of 160 ± 5 km on a single charge, optimized for
efficient urban delivery routes.
            </div>
        </details>

        <details class="faq-item">
            <summary class="faq-question">
             Can I track my delivery fleet in real-time?
            </summary>
            <div class="faq-answer">
               Yes. Integrated with VORC Connect, fleet owners can track live locations, monitor battery
status, and use Remote Immobilization to secure the vehicle instantly from any location.
            </div>
        </details>
<!-- 
        <details class="faq-item">
            ...
            <div class="faq-answer">
                The loader supports a payload capacity of up to 700 kg.
            </div>
        </details> -->
...
<a href="#" class="floating-btn btn-testdrive">
  <img src="vimage/king20.png" width="35">
