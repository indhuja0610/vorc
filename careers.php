...
<div class="container my-5">
  <div class="career-box">
    <h2 class="career-title">Work With Us</h2>

    <p class="career-text">
      We are always looking for passionate <strong>Technicians, Engineers, Sales Professionals,</strong>
      and <strong>Administrative experts</strong> to join the VORC family.
    </p>

    <p class="career-text">
      Whether your expertise is on the shop floor, in the accounts office,
      or out in the field, we want to hear from you.
    </p>

    <p class="career-text">
      Even if we don't have an active opening, we’d love to have your resume
      in our talent pool.
    </p>

    <div class="career-actions">
      <a href="mailto:hr@vorcmotors.com" class="btn btn-primary">
        📧 Email Your Resume
      </a>

      <a href="https://wa.me/+91-7845365222" target="_blank" class="btn btn-success">
        💬 Drop CV on WhatsApp
      </a>
    </div>
  </div>
