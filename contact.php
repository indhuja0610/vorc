...
<body>
     <div class="hero">
        <h1>Let's Build the Future of Logistics Together</h1>
        <p>Whether you are looking to upgrade your fleet or start your journey as a VORC partner, our team is ready to assist you.</p>
    </div>
        ...
        <div class="container">
            <div class="contact-grid">
                <div class="contact-card">
                    ...
                    <p>Primary: <a href="tel:+917539925012">+91 95005 11821  </a></p>
                    <p>Secondary: <a href="tel:+919500511821">+91 75399 25012</a></p>
                    <p style="margin-top: 15px; font-size: 0.95em;">For new vehicle bookings and fleet solutions</p>
                </div>

                <div class="contact-card">
                    <i class="fas fa-tools"></i>
                    <h3>Service & Support</h3>
                    <p>Phone: <a href="tel:+919500511434">+91 95005 11434</a></p>
                    <p style="margin-top: 15px; font-size: 0.95em;">Dedicated technical assistance for VORC owners</p>
                </div>

                <div class="contact-card">
                    <i class="fas fa-envelope"></i>
                    <h3>Email Us</h3>
                    <p>General: <a href="mailto:sales@vorcmotors.com">    <br>sales@vorcmotors.com</a></p>
                    <p>Partnerships: <a href="mailto:rajmohanselvaraj@vorcmotors.com">rajmohanselvaraj@vorcmotors.com</a></p>
                </div>
            </div>
      ...
      <label for="accept">
        ...
        <strong><a href="privacy.php" target="_blank">Privacy Policy</a></strong>.
                ...
                <div class="map-container">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d997213.1069273729!2d79.11603620580948!3d12.492035410493994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52930064647d35%3A0x2fb6fba8501d39ea!2sVORC%20Motors%20Private%20limited%20-%20(VMPL)!5e0!3m2!1sen!2sin!4v1768977407607!5m2!1sen!2sin" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>

            <div class="factory-visit">
                <h2>Visit Our Factory</h2>
                <p class="company-name">VORC MOTORS PVT LTD</p>
                <p class="tagline">Manufacturers of Electric & Hybrid Three Wheelers</p>
                <p class="address">
                    No 133, Kottaiyur, Karanai Village,<br>
                    Tiruvallur, Tamil Nadu, 631402
                </p>
                <p class="description">
                    <b>Experience first-hand how we engineer the Metro XL and Loader 600 for performance and durability.</b>
                </p>
            </div>
<!-- 
            <div class="cta-section">
                <div class="cta-card">
                    ...
                    <p>Don't just read about our specs—see them in action</p>
                </div>

                <div class="cta-card">
                    <i class="fas fa-handshake"></i>
                    <h3>Become a Dealer</h3>
                    <p>Join the growing circle of entrepreneurs who operate at just ₹0.6/km</p>
                </div>
            </div> -->

            <!-- <div class="social-proof">
                <p><i class="fas fa-check-circle" style="color: #0ea5e9; margin-right: 10px;"></i>
                Trusted by local entrepreneurs for high-performance cargo and passenger solutions | 
                <span class="highlight">Experience the VORC Edge</span></p>
            </div> -->
        </div>
    </div>
