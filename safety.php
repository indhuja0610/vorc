...
<section class="hero text-center">
    <div class="container">
        <h1 class="fw-bold mb-3">24/7 RSA Add-On</h1>
        <p class="lead">
            Designed to keep you on the move. From minor technical snags to emergency towing,
            we provide a complete safety net across India for all VORC variants.
        </p>
    </div>
</section>
...
<div class="container my-5">
    <h3 class="text-center fw-bold mb-4">What’s Included</h3>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-3">
            <div class="card feature-card h-100 text-center p-4">
                ...
                <p class="text-muted">
                    Assistance at any hour, anywhere across India.
                </p>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card feature-card h-100 text-center p-4">
                <div class="icon-circle mx-auto">🚚</div>
                <h5 class="fw-semibold">Emergency Towing</h5>
                <p class="text-muted">
                    Secure transport to the nearest authorized service center.
                </p>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card feature-card h-100 text-center p-4">
                <div class="icon-circle mx-auto">🔧</div>
                <h5 class="fw-semibold">On-Spot Minor Repairs</h5>
                <p class="text-muted">
                    Expert care for all engine and battery types.
                </p>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card feature-card h-100 text-center p-4">
                <div class="icon-circle mx-auto">⚡</div>
                <h5 class="fw-semibold">Zero-Hassle Response</h5>
                <p class="text-muted">
                    Nearest certified mechanic dispatched instantly.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="card support-card p-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="mb-1">
                    Call our dedicated support line anytime.
                </p>
                <small class="text-muted">
                    Please have your Vehicle Registration Number or VIN ready.
                </small>
            </div>
           <div class="col-md-4 text-md-end mt-3 mt-md-0">
    <a href="tel:01204501402" class="btn btn-primary btn-lg d-inline-flex align-items-center gap-2">
